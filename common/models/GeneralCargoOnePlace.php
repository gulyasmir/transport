...
class GeneralCargoOnePlace extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['length', 'width', 'height', 'weight',  /*'cargo_params', 'hazard_class',*/ 'declared_price', 'from', 'to', 'pick_up_date'], 'required'],
            [['gc_one_place_id', 'order_id', 'is_draft', 'hazard_class', 'city_pick_up', 'city_delivery', 'loading_operations', 'territory_entry','real_price'], 'integer'],
            [['length', 'width', 'height', 'weight', 'volume', 'declared_price'], 'number', 'numberPattern' => '/^\s*[-+]?[0-9]*[.,]?[0-9]*\s*$/'],
            [['hazard_class', 'city_pick_up', 'city_delivery', 'from_address_loading', 'loading_operations', 'territory_entry', 'is_draft'], 'integer'],
            [['cargo_params'], 'string', 'max' => 1000],
            [['from', 'to'], 'string', 'max' => 500],
            [['gc_one_place_id', 'order_id'], 'unique', 'targetAttribute' => ['gc_one_place_id', 'order_id']],
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\queries\GeneralCargoOnePlaceQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\queries\GeneralCargoOnePlaceQuery(get_called_class());
    }
