...
class DedicatedTransportTruck extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['dt_truck_id', 'order_id', 'tent_hard_board', 'tent_removable_top_beam', 'tent_removable_side_beam', 'hazard_class', 'city_pick_up', 'city_delivery', 'from_address_loading', 'loading_operations', 'territory_entry', 'filling', 'hard_package', 'pallet_transparent', 'pallet_black', 'tent_remove_to', 'tent_remove_from', 'pallet_board_pack', 'is_draft','real_price'], 'integer'],
            [['declared_price'], 'number'],
            ['semi_trailer_type', 'in', 'range' => [1, 2]],
            [['cargo_params'], 'string', 'max' => 1000],
            [['from', 'to'], 'string', 'max' => 500],
            [['dt_truck_id', 'order_id'], 'unique', 'targetAttribute' => ['dt_truck_id', 'order_id']],
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\queries\DedicatedTransportTruckQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\models\queries\DedicatedTransportTruckQuery(get_called_class());
    }
