...
/**
 * DedicatedTransportTruckSearch represents the model behind the search form of `common\models\DedicatedTransportTruck`.
 */
class DedicatedTransportTruckSearch extends DedicatedTransportTruck
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['dt_truck_id', 'user_id', 'semi_trailer_type', 'tent_hard_board', 'tent_removable_top_beam', 'tent_removable_side_beam', 'hazard_class', 'city_pick_up', 'city_delivery', 'pick_up_date', 'from_address_loading', 'loading_operations', 'territory_entry', 'filling', 'hard_package', 'pallet_transparent', 'pallet_black', 'tent_remove_to', 'tent_remove_from', 'pallet_board_pack', 'is_draft'], 'integer'],
    ...
    {
        $query = DedicatedTransportTruck::find();

        // add conditions that should always apply here
        
        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'sort'=> ['defaultOrder' => ['dt_truck_id'=>SORT_DESC]]
        ]);
        ...
        $query->andFilterWhere([
            'dt_truck_id' => $this->dt_truck_id,
            'semi_trailer_type' => $this->semi_trailer_type,
            'tent_hard_board' => $this->tent_hard_board,
            'tent_removable_top_beam' => $this->tent_removable_top_beam,
            'tent_removable_side_beam' => $this->tent_removable_side_beam,
