...
/**
 * GeneralCargoLetterSearch represents the model behind the search form of `common\models\GeneralCargoLetter`.
 */
class GeneralCargoLetterSearch extends GeneralCargoLetter
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['gc_letter_id', 'user_id', 'city_pick_up', 'city_delivery', 'pick_up_date', 'territory_entry', 'is_draft'], 'integer'],
    ...
    {
        $query = GeneralCargoLetter::find();

        // add conditions that should always apply here

        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'sort'=> ['defaultOrder' => ['gc_letter_id'=>SORT_DESC]]
        ]);
        ...
        $query->andFilterWhere([
            'gc_letter_id' => $this->gc_letter_id,
            'length' => $this->length,
            'width' => $this->width,
            'height' => $this->height,
            'weight' => $this->weight,
