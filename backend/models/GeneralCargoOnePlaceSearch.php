...
/**
 * GeneralCargoOnePlaceSearch represents the model behind the search form of `common\models\GeneralCargoOnePlace`.
 */
class GeneralCargoOnePlaceSearch extends GeneralCargoOnePlace
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['gc_one_place_id', 'user_id', 'hazard_class', 'city_pick_up', 'city_delivery', 'pick_up_date', 'from_address_loading', 'loading_operations', 'territory_entry', 'is_draft'], 'integer'],
    ...
    {
        $query = GeneralCargoOnePlace::find();

        // add conditions that should always apply here

        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'sort'=> ['defaultOrder' => ['gc_one_place_id'=>SORT_DESC]]
        ]);
        ...
        $query->andFilterWhere([
            'gc_one_place_id' => $this->gc_one_place_id,
            'length' => $this->length,
            'width' => $this->width,
            'height' => $this->height,
            'weight' => $this->weight,
