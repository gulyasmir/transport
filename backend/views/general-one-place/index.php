...
/* @var $searchModel backend\models\GeneralCargoOnePlaceSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Сборный груз одно место';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="general-cargo-one-place-index">
    ...
    <!--<p>
        <?= Html::a('Создать заказ (Сборный груз 1 место)', ['create'], ['class' => 'btn btn-success']) ?>
    </p>-->
