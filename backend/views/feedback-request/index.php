...
/* @var $searchModel backend\models\FeedbackRequestSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Заявки обратная связь';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="feedback-request-index">
    ...
    <!--<p>
        <?= Html::a('Создать заявку (обратная связь)', ['create'], ['class' => 'btn btn-success']) ?>
    </p>-->
