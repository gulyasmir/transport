...
/* @var $searchModel backend\models\GeneralCargoManyPlacesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Сборный груз несколько мест';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="general-cargo-many-places-index">
    ...
    <!--<p>
        <?= Html::a('Создать заказ (Сборный груз несколько мест)', ['create'], ['class' => 'btn btn-success']) ?>
    </p>-->
