...
<div class="general-cargo-many-places-form">
...
<?= $form->field($model, 'city_pick_up', ['template'=>'{input}{label}'])->textInput(['class'=>"",'type'=>'checkbox', 'checked' => (isset($model->city_pick_up) ? (boolean)$model->city_pick_up : false), 'value' => '1'])?>
    ...
    <?= $form->field($model, 'biggest_length')->textInput() ?>

    <?= $form->field($model, 'biggest_width')->textInput() ?>

    <?= $form->field($model, 'biggest_height')->textInput() ?>

    <?= $form->field($model, 'biggest_weight')->textInput() ?>

    <?= $form->field($model, 'place_quantity')->textInput() ?>

    <?= $form->field($model, 'overall_volume')->textInput() ?>

    <?= $form->field($model, 'overall_weight')->textInput() ?>
