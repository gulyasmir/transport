...
/* @var $searchModel backend\models\GeneralCargoLetterSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Сборный груз письмо';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="general-cargo-letter-index">
    ...
    <!--<p>
        <?= Html::a('Создать заказ (Сборный груз письмо)', ['create'], ['class' => 'btn btn-success']) ?>
    </p>-->
