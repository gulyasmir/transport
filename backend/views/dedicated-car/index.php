...
/* @var $searchModel backend\models\DedicatedTransportCarSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Выделенный транспорт машина';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="dedicated-transport-car-index">
    ...
    <!--<p>
        <?= Html::a('Создать заказ (Выделенный транспорт машина)', ['create'], ['class' => 'btn btn-success']) ?>
    </p>-->
