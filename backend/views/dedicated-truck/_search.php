...
/* @var $model backend\models\DedicatedTransportTruckSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="dedicated-transport-truck-search">
    ...
    <?= $form->field($model, 'dt_truck_id') ?>

    <?= $form->field($model, 'customer_id') ?>

    <?= $form->field($model, 'semi_trailer_type') ?>

    <?= $form->field($model, 'tent_hard_board') ?>

    <?= $form->field($model, 'tent_removable_top_beam') ?>

    <?php // echo $form->field($model, 'tent_removable_side_beam') ?>
